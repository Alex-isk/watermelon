...
class WatermelonColors {

  WatermelonColors._();

  static const greenText = Color.fromRGBO(255, 255, 115, 115);
  static const blackText = Color.fromRGBO(0, 0, 0, 0.87);
  static const backgroundGreen = Color.fromRGBO(3, 136, 0, 1);
  static const red = Color(0xFFEF5350);
  static const red2 = Color(0xFFE57373);
  ...
  static const red4 = Color.fromRGBO(112, 46, 45, 1);
  ...
  static const grey2 = Color.fromRGBO(45, 65, 73, 1.0);
  static const pink = Color.fromRGBO(245, 143, 146, 1);
  static const lightpink = Color.fromRGBO(238, 204, 204, 1.0);
  static const lightpink2 = Color.fromRGBO(176, 111, 114, 1.0);
